...
function Presentation() {
    ...
    return (
        <div className='max-w-svw md:max-w-[50rem]'>
            <div className='relative w-full'>
                <img
                    className='absolute rounded-sm w-[50rem] h-44'
                    rel='preload'
                    src='https://i.pinimg.com/736x/19/2d/bd/192dbd59eede15c884eec12ba365cbd9.jpg'
                ...
                <div className='w-32 lg:w-40'>
                    <motion.button
                        ...
                        <img
                            ...
                            alt='user icon'
                            draggable='false'
                            className='z-10 relative bg-[#0e0f1fa8] shadow-[5px_5px_0px_0px_rgba(0,_0,_0,_0.5)] m-0 p-0 border-[#0e0f1f] border-4 rounded-full w-32 lg:w-40 h-auto duration-200 select-none'
                        />
                    </motion.button>
                </div>
                ...
                <main className='self-center'>
                    <div className=''>
                        ...
                        <p className='p-2 md:pt-2 text-gray-300 md:text-md text-sm'>
                            {lang === 'eng'
                                ...
                                : 'Constantemente busco mejorar, desarrollar mis habilidades y ganar conocimiento para poder realizar las mejores soluciones en el momento correcto'}
                        </p>
                    </div>
                    ...
                    <div className='flex flex-row flex-wrap justify-start md:gap-2 p-2 max-w-svw font-semibold text-center'>
                        <a
                            href={
                                lang === 'eng'
                                    ? '../../assets/Cv/Eng/CV_Dylan_Correa.docx'
                                    : '../../assets/Cv/Esp/CV_Dylan_Correa_Español.docx'
                            }
                            download={
                                lang === 'eng'
                                    ? 'Dylan Correa Cv ingles.docx'
                                    : 'Dylan Correa Cv español.docx'
                            }
                        ...
                        <span className='flex justify-center mx-2 py-1 rounded-md font-semibold text-gray-400 hover:text-white hover:scale-105 duration-150'>
                            ...
                            <p>{lang === 'eng' ? 'Available' : 'Disponible'}</p>
                        </span>
                        <a
                            href='https://www.linkedin.com/in/dylan-correa-586a012a9/'
                            className='flex justify-center mx-2 py-1 rounded-md font-semibold text-gray-400 hover:text-white hover:scale-105 duration-150'>
                            <FaLinkedinIn className='m-auto pr-1 text-gray-200 text-2xl' />
                            Linkedin
                        </a>
                        <a
                            href='https://github.com/DylanEzequiel'
                            className='flex justify-center mx-2 py-1 rounded-md font-semibold text-gray-400 hover:text-white hover:scale-105 duration-150'>
