...
import { GrDeploy, GrOptimize } from 'react-icons/gr';
...
function Quantity() {
    ...
    return (
        <section className='flex md:flex-row flex-col justify-center items-center gap-4 my-24'>
            <div className='group flex flex-col justify-around items-center bg-gray-600/20 shadow-md border border-gray-700 rounded-lg w-60 h-44 text-white hover:scale-105 transition-all duration-300 ease-in-out'>
