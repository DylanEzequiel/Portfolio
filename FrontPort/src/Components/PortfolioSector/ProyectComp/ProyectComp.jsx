  ...
  return (
    <article className='group flex md:flex-row flex-col md:gap-4 lg:m-2 my-10 p-2 rounded-md'>
        ...
        <main className='flex flex-col justify-between gap-2 p-2 w-full'>
            ...
            <div className='flex'>
                {github?
                    <a href={github} className='flex justify-center gap-1 bg-indigo-900/40 hover:bg-indigo-900 hover:shadow-[0px_0px_8px_4px_rgba(36,48,137,1)] m-2 px-4 py-1 rounded-md font-semibold text-white hover:scale-105 duration-150'><FaGithub className='self-center' /> GitHub</a>
                :null}
                {vercel?
                    <a  href={vercel} className='flex justify-center gap-1 bg-indigo-900/40 hover:bg-indigo-900 hover:shadow-[0px_0px_8px_4px_rgba(36,48,137,1)] m-2 px-4 py-1 rounded-md font-semibold text-white hover:scale-105 duration-150'><BsBoxArrowUpRight  className='self-center' /> {lang=="eng"?"Visit":"Visitar"} </a>
                :null}
            </div>
